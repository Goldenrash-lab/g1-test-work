            ...
            (e = function () {
              !(function (e, t) {
                ...
                (e._gaq = e._gaq || []),
                    ...
                    (function () {
                      ...
                      function a() {
                        !(function () {
                          var e,
                            i,
                            n = t("[data-track-scroll]");
                          for (e = 0; e < n.length; e++)
                            (i = n.eq(e)), r.scrollTrackItems.push(i);
                        })(),
                          i.on("scroll.event-tracker", function () {
                            o &&
                              ((o = !1),
                              setTimeout(function () {
                                var t = g();
                      ...
                      function c() {
                        t("body").on(
                          ...
                          "[data-track-links]",
                          function (e) {
                            "A" === e.target.tagName && v(t(e.target));
                          }
                        );
                      }
                      function u(e) {
                        ...
                        for (i = 0; i < r.scrollTrackItems.length; i++)
                          e > (t = r.scrollTrackItems[i]).offset().top + n
                            ? d(t)
                            : o.push(t);
                        r.scrollTrackItems = o;
                      }
                      function h(e) {
                      ...
                      function g() {
                        return (
                          (function () {
                            return i.scrollTop.apply(i, arguments);
                          })() + i.height()
                        );
                      }
                      return {
                        ...
                        destroy: function () {
                          t("body").off(".event-tracker"),
                            t(e).off(".event-tracker");
                        },
                        initClicks: s,
                        initScroll: a,
                        initLinks: c,
                  ...
                  e.glb.ElementTracker.init();
              })(window, jQuery);
            }),
              window.setTimeout(function t() {
                window.jQuery ? e() : window.setTimeout(t, 20);
              }, 20);
          },
          !1
        );
      ...
      document.querySelectorAll("amp-social-share").forEach((e) => {
        e.addEventListener("click", (e) => {
          var t,
            i,
            n =
              null == (t = e.target.attributes) || null == (i = t.type)
                ? void 0
                : i.value;
          if (!e.target.attributes.type) {
            var o,
              r,
              l = e.target.closest("amp-social-share");
            l &&
              (n =
                null == (o = l.attributes) || null == (r = o.type)
                  ? void 0
                  : r.value);
          }
          globalThis.ga &&
    ...
    n.a = function () {
      return {
        ga: {
          ...
          extras: {
            dimension21: e("bd_suser_provider"),
            dimension22: e("bd_suser_code"),
            dimension98: e("bd_suser_provider"),
            dimension99: e("bd_suser_code"),
          },
        },
      };
    };
  ...
  function (t, n, r) {
    (function (n, r) {
      t.exports = (function () {
        ...
        function T(t, n) {
          t._state === _ && ((t._state = j), (t._result = n), u(E, t));
        }
        function A(t, n, r, e) {
              ...
              (t.prototype._eachEntry = function (t, n) {
                ...
                if (e === m) {
                  ...
                  if (o === w && t._state !== _)
                    ...
                    var u = new r(g);
                    a ? T(u, i) : x(u, t, o), this._willSettleAt(u, n);
                  } else
                    this._willSettleAt(
                      new r(function (n) {
                        return n(t);
            ...
            (i._invoke = (function (t, n, r) {
              ...
              return function (o, i) {
                ...
                for (r.method = o, r.arg = i; ; ) {
                  ...
                  var c = f(t, n, r);
                  if ("normal" === c.type) {
                    if (((e = r.done ? d : h), c.arg === v)) continue;
                    return { value: c.arg, done: r.done };
                  }
                  "throw" === c.type &&
                    ((e = d), (r.method = "throw"), (r.arg = c.arg));
                }
              };
            })(t, r, a)),
            i
          ...
          : new n(function (n, r) {
              p = (function e(o) {
                return setInterval(function () {
                  ...
                  return d && d.done
                    ? (clearInterval(p), void n(d.value))
                    : (function (t, n) {
                        return t + n < Date.now();
                      })(f, s)
                    ? (clearInterval(p),
                    ...
                    : u < l
                    ? ((l = 0), (h *= 2), clearInterval(p), void (p = e(h)))
                    : void (l += 1);
                }, o);
              })(h);
            });
          ...
          (a.prototype.calc = function () {
            ...
            (a.prototype.getLineCount = function (e) {
              return e.offsetWidth > this.columnWidth
                ...
                : c(e.clientHeight, this.lineHeight);
            }),
      ...
      279: (e, t, n) => {
        ...
        e.exports = function (e, t, n) {
          ...
          function y(t) {
            var n = l,
              i = c;
            return (l = c = void 0), (v = t), (u = e.apply(i, n));
          }
          function w(e) {
            var n = e - p;
          ...
          function b(e) {
            return (h = void 0), f && l ? y(e) : ((l = c = void 0), u);
          }
          function I() {
            var e = o(),
              n = w(e);
            if (((l = arguments), (c = this), (p = e), n)) {
              if (void 0 === h)
                return (function (e) {
                  return (v = e), (h = setTimeout(_, t)), m ? y(e) : u;
                })(p);
              if (g) return clearTimeout(h), (h = setTimeout(_, t)), y(p);
            }
  ...
  (n.n = (e) => {
    ...
    (() => {
      ...
      var r,
        a = n(0),
        s = n.n(a),
        l = (null == (r = window.cdaaas) ? void 0 : r.SETTINGS) || {},
        c = "shadow-video-flow",
        d = l.SITE_ID,
        u =
          (l.MOBILE_GROUP,
        ...
        h =
          ...
          "qa" === u ||
          l.IS_PREVIEW ||
          window.location.hash.substr(1) === c + "-debug"
            ? "debug"
            : "warn",
        p = c,
        v = "." + p,
        m = { ENV: "prod" === u ? u : "qa", SHOW_ALTERNATIVE: l.IS_PREVIEW },
        g = {
          g1: "https://recomendacao.globo.com/rec/v2/item/g1/videos-mc-shadow",
          gshow:
            "https://recomendacao.globo.com/rec/v2/item/gshow/videos-mc-shadow",
          multishow:
            "https://recomendacao.globo.com/rec/v2/item/multishow/videos-mc-shadow",
          redeglobo:
            "https://recomendacao.globo.com/rec/v2/item/redeglobo/videos-mc-shadow",
          gnt: "https://recomendacao.globo.com/rec/v2/item/gnt/videos-mc-shadow",
          ge: "https://recomendacao.globo.com/rec/v2/item/ge/videos-mc-shadow",
        }[d],
        f = {
          METHOD: {
            g1: "g1_portal.send",
        ...
        y = Boolean(window.Element.prototype.animate),
        w = {
          0: "jan",
          1: "fev",
          2: "mar",
      ...
      class N {
        ...
        static register(e, t) {
          N.getListeners(e).push(t);
        }
        static send(e, t) {
          return C(function* () {
            void 0 === t && (t = {});
            var n = N.getListeners(e);
            _(
              "log",
              "Interação " +
                e +
      ...
      const S = N,
        O = class {
          ...
          userNavigateToPrevious() {
            this.currentItemIndex > 0 &&
              (this.navigateToPrevious(), this._sendInteraction(t));
          }
          userNavigateToNext() {
            this.currentItemIndex < this.itemList.length &&
              (this.navigateToNext(), this._sendInteraction(e));
          }
        };
      var R,
        D,
      ...
      window.HorizonClient.then((e) => {
        R = e;
      }).then(() => {
        globalThis.globalWebdeps("globo-ab").then(() => {
          (D = new window.GloboAB(m.ENV, R)).options().timeout(3e3);
        });
      });
      const F = class {
        constructor(e) {
          (this.experimentName = e), (this._interactionsSent = []);
        }
        _send(e) {
          return (
            _(
          ...
          return (
            _(
              ...
              "Enviando " +
                ...
                " para alternativa " +
                t,
              "com testId " + n + " e originURL " + i
            ),
            D[e](
              { experiment: this.experimentName, alternative: t, testId: n },
              D.options().withOriginURL(i)
            )
          );
        }
        send(e) {
          if (!this._interactionsSent.includes(e))
            try {
              if (this.experimentInstance) this._send(e);
              else {
                for (
                  var t = arguments.length,
                  ...
                  n[i - 1] = arguments[i];
                this._sendCustom(e, ...n);
              }
              this._interactionsSent.push(e);
            } catch (t) {
              _(
                "error",
                "Falha ao enviar " +
        ...
        choose() {
          var e = this;
          return M(function* () {
            var t = D.createOptions().enableGADebugger().skipImpression();
            try {
              e.experimentInstance = yield D.choose(e.experimentName, t);
            } catch (t) {
              throw (
                (_(
                  "error",
      ...
      class q {
        constructor() {
          (this.videos = null),
            S.register(i, this.buildAndSendVideoConversion.bind(this)),
            S.register(e, this.buildAndSendVideoImpression.bind(this)),
            S.register(
              o,
              V()(this.buildAndSendFirstVideoImpression.bind(this))
            );
        }
        static _getEndpoint(e) {
          var t = e;
          return (
            (t += "?registerImpression=false") +
            "&url=" +
        ...
        static _requestData(e) {
          return H(function* () {
            var t = q._getEndpoint(e);
            try {
              return (yield fetch(t, j)).json();
            } catch (e) {
              throw new Error(
                "Fail to fetch recommendated videos from URL " + t
              );
            }
          })();
        }
        getVideos(e) {
          ...
          return H(function* () {
            return (
              null === t.videos && (t.videos = yield q._requestData(e)),
              t.videos
            );
          })();
        }
        getVideoById(e) {
          return this.videos.find((t) => t.content.video.id === e);
        }
        static getVideoAlternativeData(e, t) {
          ...
          return (
            r || ((r = new F(n)), (G[t] = r)),
            { abClient: r, alternative: i, testId: o }
          );
        }
          ...
          return H(function* () {
            ...
            if (i) {
              var {
                  ...
                  alternative: r,
                  testId: a,
                } = q.getVideoAlternativeData(i, n),
                s = i.content.video.url;
              o.sendConversion(r, a, s);
            }
          })();
        }
      ...
      const Y = class {
        ...
        insertInto(e) {
          this.inserted
            ...
            : (this.nodeArray.forEach((e) => z(e, "add", Q)),
              e.appendChild(this.documentFragment),
              (this.inserted = !0));
        }
        show() {
          this.nodeArray.forEach((e) => z(e, "remove", Q));
        }
      };
      class X {
        constructor(e) {
        ...
        static _fillContent(e, t) {
          e.querySelectorAll("[data-property-name]").forEach((e) => {
            e.textContent = (0, B.get)(t, e.dataset.propertyName) || "";
          });
        }
        createElement() {
        ...
        render(e) {
          ...
          return X._fillContent(t, e), new Y(t);
        }
      }
      const $ = X,
        J = {
      ...
      const ie = class {
          constructor(e, t) {
            void 0 === t && (t = {}),
              (this.containerEl = e),
              (this.events = t),
              (this.template = new $(e.querySelector("template").content)),
          ...
          static afterUpdate() {}
          hasUpdateAnimation() {
            return y && this.updateAnimation;
          }
          animatedHide(e) {
            var t = this;
            return ne(function* () {
              if (t.hasUpdateAnimation()) {
                var n = new ee(e, { keyframes: t.updateAnimation.hide });
                yield n.play();
              }
              !(function (e, t) {
          ...
          render(e) {
            ...
            return (
              ...
              I(this, "beforeUpdate")(t, e),
              t.insertInto(this.containerEl),
              I(this, "afterUpdate")(t, e),
        ...
        oe = class extends ie {
          constructor() {
            super(...arguments),
              (this.updateAnimation = { hide: J.FADE_OUT, show: J.FADE_IN });
          }
          static afterUpdate(e) {
            ...
            })(e.querySelector(v + "-video-info__description"));
          }
          update(e) {
      ...
      class le {
        static hash(e, t) {
          ...
          for (
            ...
            for (var d = 0; d < 16; d++)
              l[c][d] =
                (e.charCodeAt(64 * c + 4 * d + 0) << 24) |
                (e.charCodeAt(64 * c + 4 * d + 1) << 16) |
                (e.charCodeAt(64 * c + 4 * d + 2) << 8) |
                (e.charCodeAt(64 * c + 4 * d + 3) << 0);
          }
          ...
          for (var p = 0; p < s; p++) {
            ...
            for (var g = 16; g < 64; g++)
              v[g] =
                (le.σ1(v[g - 2]) + v[g - 7] + le.σ0(v[g - 15]) + v[g - 16]) >>>
                0;
            for (
              var f = r[0],
                y = r[1],
              ...
              var A = T + le.Σ1(b) + le.Ch(b, I, x) + o[E] + v[E],
                C = le.Σ0(f) + le.Maj(f, y, w);
              (T = x),
                (x = I),
                (I = b),
                (b = (_ + A) >>> 0),
          ...
          for (var P = 0; P < r.length; P++)
            r[P] = ("00000000" + r[P].toString(16)).slice(-8);
          var N = "hex-w" == i.outFormat ? " " : "";
          return r.join(N).toUpperCase();
        }
        static ROTR(e, t) {
          return (t >>> e) | (t << (32 - e));
        }
        static Σ0(e) {
          return le.ROTR(2, e) ^ le.ROTR(13, e) ^ le.ROTR(22, e);
        }
        static Σ1(e) {
          return le.ROTR(6, e) ^ le.ROTR(11, e) ^ le.ROTR(25, e);
        }
        static σ0(e) {
          return le.ROTR(7, e) ^ le.ROTR(18, e) ^ (e >>> 3);
        }
        static σ1(e) {
          return le.ROTR(17, e) ^ le.ROTR(19, e) ^ (e >>> 10);
        }
        static Ch(e, t, n) {
          return (e & t) ^ (~e & n);
        }
      ...
      function ue(e) {
        return function () {
          ...
          return new Promise(function (i, o) {
            ...
            function s(e) {
              de(r, i, o, a, s, "throw", e);
            }
            a(void 0);
          });
        };
      }
      var he = (e, t) => (e ? e + "&" : "") + new URLSearchParams(t).toString();
      function pe() {
        return (
          (pe = ue(function* () {
            var e,
              t,
              n = (window.cdaaas || {}).SETTINGS || {},
              i = {
                hostWebmedia: n.HOST_WEBMEDIA,
                adUnit: n.TAG_MANAGER_AD_UNIT,
                adCustomData: n.TAG_MANAGER_AD_CUSTOM_DATA,
                extras: n.TAG_MANAGER_AD_EXTRAS,
                gaProductUA: n.PRODUCT_UA,
              };
            try {
              var o = yield new Promise((e) => {
                var t = window.glb.globoIdClientMap.getGloboIdClient(re);
              ...
              if (void 0 !== o) {
                var r = yield new Promise((e) => {
                  ...
                  a = "authorized" === r[0].status;
                (i.adCustomData = he(i.adCustomData, {
                  "ext-bsafety": window.utag_data["ext-bsafety"] || "",
                  glb_id: (a && o.globo_id) || T("glb_uid"),
                  glb_tipo: a ? "logado" : "anonimo",
                  ambient: "web",
                  tipo_pagina: window.utag_data.tipo_pagina,
                  tvg_pgName: window.cdaaas.SETTINGS.TITLE,
                })),
                  (i.adPublisherProvidedID = a ? ce.hash(o.globo_id) : "");
              } else (i.adCustomData = he(i.adCustomData, { "ext-bsafety": window.utag_data["ext-bsafety"] || "", glb_id: T("glb_uid"), glb_tipo: "anonimo", ambient: "web", tipo_pagina: window.utag_data.tipo_pagina, tvg_pgName: window.cdaaas.SETTINGS.TITLE })), (i.adPublisherProvidedID = "");
            } catch (e) {
              _("warn", e);
            }
            return {
              width: "100%",
              height: "100%",
              webmedia_url: i.hostWebmedia,
              adUnit: i.adUnit,
              adCustomData: i.adCustomData,
              adPublisherProvidedID: i.adPublisherProvidedID,
              events: {},
              extras: i.extras,
              plugins: { container: [] },
              ga: {
                productUA: i.gaProductUA,
                extras: {
                  dimension1: "web",
                  dimension98:
                    (null == (e = window.dataLayer) ||
                    null == (e = e.find((e) => "bd_suser_provider" in e))
                      ? void 0
                      : e.bd_suser_provider) || "",
                  dimension99:
      ...
      var ge = x("__player-container--loaded"),
        fe = {
          next: { hide: J.FADE_OUT_TO_LEFT, show: J.FADE_IN_FROM_RIGHT },
          previous: { hide: J.FADE_OUT_TO_RIGHT, show: J.FADE_IN_FROM_LEFT },
        };
      class ye extends ie {
        constructor(e, t) {
          super(e.querySelector(v + "-player__placeholder-container"), t),
        ...
        get updateAnimation() {
          return fe[this._animationDirection];
        }
        static beforeUpdate(e, t) {
          ye.updateThumb(e, t.currentItem.content);
        }
        static updateThumb(e, t) {
          var n = e.querySelector(v + "-player__placeholder-thumb"),
            i = t.title,
            o = t.image.sizes.M.url;
          (n.src = o), (n.title = i), (n.caption = i);
        }
        afterUpdate(e, t) {
          this._videoReadyPromise = new E();
          try {
            this.initPlayer(t),
        ...
        bindPlayVideo(e, t) {
          var n = e.querySelector(v + "-player__placeholder");
          n.addEventListener("click", this.playVideo),
            n.addEventListener(
              "click",
              () => {
                S.send(i, {
                  position: t.currentIndex + 1,
                  videoId: t.currentItem.content.video.id,
                  videoTitle: t.currentItem.content.title,
                  videoURL: t.currentItem.content.url,
                  componentItem: "shadow-video-flow-player__placeholder",
                  componentLabel: "play_video",
                  componentPosition:
                    n.getBoundingClientRect().top + window.scrollY,
                });
              },
              { once: !0 }
            );
        ...
        playVideo() {
          (this._autoPlay = !1),
            this._videoReadyPromise.then(() => {
              this.player.play(), this.rootContainerEl.classList.add(ge);
            });
        }
        ...
        update(e) {
          this.rootContainerEl.classList.remove(ge),
      ...
      const xe = class extends ie {
        constructor() {
          super(...arguments),
            (this.handleNextClick = Ie()(this.handleNextClick.bind(this), 600)),
            (this.handlePreviousClick = Ie()(
        ...
        bindNavigation(e, t) {
          var n = e.querySelector(v + "-navigation__button-prev"),
            i = e.querySelector(v + "-navigation__button-next");
          t.previousItem
          ...
          init() {
            ...
            return Ee(function* () {
              var t,
                ...
                a = [];
              try {
                a = yield e.recommendation.getVideos(e.recommendationEndpoint);
              } catch (e) {
                (a = []), _("error", "[init] Failed to getVideos: " + e);
              }
              a.length
                ? ((e.navigation = new O(a, { onNavigate: e.render })),
                  (e.components = [
                    new oe(e.infoContainerEl),
                    new _e(e.issuedContainerEl),
                    new we(e.playerContainerEl, {
                      navigateToNext: e.navigation.navigateToNext,
                    }),
                    new xe(e.navigationContainerEl, {
                      onPrevious: e.navigation.userNavigateToPrevious,
                      onNext: e.navigation.userNavigateToNext,
                    }),
                  ]),
                  (t = e.containerEl.querySelectorAll(".glb-skeleton-box")) &&
                    t.forEach((e) => e.remove()),
                  (n = e.containerEl),
                  (i = -100),
                  (r = e.navigation.context.currentItem),
                  void 0 === i && (i = 0),
                  void 0 === r && (r = null),
                  window.ScrollSpy
                  ...
                  e.render())
                : e.containerEl && (e.containerEl.style.display = "none");
            })();
          }
          render() {
            var e = this;
      ...
      class Re {
        ...
        send(e, t, n) {
          Pe(
            ...
            Ne(this.methodName, this.hitType, this.category, e, t),
            Oe(this.methodName, this.hitType, this.category, e, t, n);
        }
        sendImpression(e) {
      ...
      (() => {
        var n = document.querySelector(v);
        if (n) {
                ...
                r.isIntersecting &&
                  (s ||
                    ((n) => {
                      var r;
                      f.METHOD
                        ? ((r = new Re(f.CATEGORY, f.METHOD)),
                          S.register(o, r.sendImpression),
                          S.register(i, r.sendVideoPlay),
                          S.register(t, r.sendNavigationPrevious),
                          S.register(e, r.sendNavigationNext))
                        : _(
                            "warn",
                        ...
                        n &&
                          new Ae(n, g)
                            .init()
                            .catch((e) =>
                              _("error", "Failed to init player: " + e)
                            );
                    })(n),
                  (s = !0),
                  a.unobserve(l));
...
(() => {
  ...
  var n =
    ...
    e = {
      g1: "https://recomendacao.globo.com/rec/v2/item/g1/post-top-1h?limit=6",
    }[r],
  ...
  function u(n, a, r, t, e, i, o) {
    ...
    s.done ? a(c) : Promise.resolve(c).then(t, e);
  }
  function m(n) {
    return function () {
      var a = this,
  ...
  function h() {
    return (h = m(function* () {
      var n = yield fetch(e + "&url=" + window.location.href, t)
          .then((n) => n.json())
          .catch((n) =>
